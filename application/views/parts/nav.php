        ...
        <header id="header">
            <div class="logo">
                <a href="<?php echo base_url()?>" class="hidden-xs">
                    Inventory
                    <small>All of you need is here</small>
                </a>
            ...
            <ul class="top-menu">
                ...
                <li class="top-menu__profile dropdown">
                    <a data-toggle="dropdown" href="#">
                        <img src="<?php echo base_url()?>assets/demo/img/profile-pics/1.jpg" alt="">
                    </a>
                    ...
                    <div class="tab-pane" id="notifications__messages">
                        <div class="list-group">
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url()?>assets/demo/img/profile-pics/1.jpg" alt="">
                                </div>
                            ...
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url()?>assets/demo/img/profile-pics/5.jpg" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url()?>assets/demo/img/profile-pics/3.jpg" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url()?>assets/demo/img/profile-pics/4.jpg" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <a href="#" class="list-group-item media">
                                <div class="pull-left">
                                    <img class="avatar-img" src="<?php echo base_url()?>assets/demo/img/profile-pics/2.jpg" alt="">
                                </div>
                                <div class="media-body">
            ...
            <aside id="navigation">
                ...
                <div class="navigation__menu c-overflow">
                    <ul>
                        ...
                        <li><a href="<?php echo base_url()?>assets/typography.html"><i class="zmdi zmdi-format-underlined"></i> Typography</a></li>
                        <li><a href="<?php echo base_url()?>assets/widgets.html"><i class="zmdi zmdi-widgets"></i> Widgets</a></li>
                        <li class="navigation__sub">
                            <a href="#" data-mae-action="submenu-toggle"><i class="zmdi zmdi-view-list"></i> Peminjaman Barang</a>

                            <ul>
                                <li><?php echo anchor('transaksi','Daftar Peminjaman ') ?></li>
                                <li><?php echo anchor('transaksikembali','Pengembalian Barang ') ?></li>
                                <li><?php echo anchor('transaksi/pinjam','Barang Belum Kembali ') ?></li>
                            </ul>
                        </li>
                        <li class="navigation__sub">
                            <a href="#" data-mae-action="submenu-toggle"><i class="zmdi zmdi-collection-text"></i> Forms</a>
                            <ul>
                                <li><a href="<?php echo base_url()?>assets/form-elements.html">Basic Form Elements</a></li>
                                <li><a href="<?php echo base_url()?>assets/form-components.html">Form Components</a></li>
                                <li><a href="<?php echo base_url()?>assets/form-examples.html">Form Examples</a></li>
                                <li><a href="<?php echo base_url()?>assets/form-validations.html">Form Validation</a></li>
                            </ul>
                        </li>
                        <li class="navigation__sub">
                            <a href="#" data-mae-action="submenu-toggle"><i class="zmdi zmdi-swap-alt"></i>User Interface</a>
                            <ul>
                                <li><a href="<?php echo base_url()?>assets/animations.html">Animations</a></li>
                                <li><a href="<?php echo base_url()?>assets/buttons.html">Buttons</a></li>
                                <li><a href="<?php echo base_url()?>assets/icons.html">Icons</a></li>
                                <li><a href="<?php echo base_url()?>assets/alerts.html">Alerts</a></li>
                                <li><a href="<?php echo base_url()?>assets/preloaders.html">Preloaders</a></li>
                                <li><a href="<?php echo base_url()?>assets/notification-dialog.html">Notifications & Dialogs</a></li>
                                <li><a href="<?php echo base_url()?>assets/media.html">Media</a></li>
                                <li><a href="<?php echo base_url()?>assets/components.html">Components</a></li>
                            </ul>
                        </li>
                        <li class="navigation__sub">
                            <a href="#" data-mae-action="submenu-toggle"><i class="zmdi zmdi-trending-up"></i>Charts</a>
                            <ul>
                                <li><a href="<?php echo base_url()?>assets/flot-charts.html">Flot Chart</a></li>
                                <li><a href="<?php echo base_url()?>assets/other-charts.html">Others</a></li>
                            </ul>
                        </li>
                        <li class="navigation__sub">
                            <a href="#" data-mae-action="submenu-toggle"><i class="zmdi zmdi-image"></i>Photo Gallery</a>
                            <ul>
                                <li><a href="<?php echo base_url()?>assets/photos.html">Default</a></li>
                                <li><a href="<?php echo base_url()?>assets/photo-timeline.html">Timeline</a></li>
                            </ul>
                        </li>
                        <li><a href="<?php echo base_url()?>assets/calendar.html"><i class="zmdi zmdi-calendar"></i> Calendar</a></li>
                        <li><a href="<?php echo base_url()?>assets/generic-classes.html"><i class="zmdi zmdi-layers"></i> Generic Classes</a></li>
                        <li class="navigation__sub">
                            <a href="#" data-mae-action="submenu-toggle"><i class="zmdi zmdi-collection-item"></i> Sample Pages</a>
                            <ul>
                                <li><a href="<?php echo base_url()?>assets/profile-timeline.html">Profile</a></li>
                                <li><a href="<?php echo base_url()?>assets/list-view.html">List View</a></li>
                                <li><a href="<?php echo base_url()?>assets/messages.html">Messages</a></li>
                                <li><a href="<?php echo base_url()?>assets/pricing-table.html">Pricing Table</a></li>
                                <li><a href="<?php echo base_url()?>assets/contacts.html">Contacts</a></li>
                                <li><a href="<?php echo base_url()?>assets/wall.html">Wall</a></li>
                                <li><a href="<?php echo base_url()?>assets/invoice.html">Invoice</a></li>
                                <li><a href="<?php echo base_url()?>assets/login.html">Login and Sign Up</a></li>
                                <li><a href="<?php echo base_url()?>assets/lockscreen.html">Lockscreen</a></li>
